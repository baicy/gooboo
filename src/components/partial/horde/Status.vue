...
export default {
  components: { Active, PlayerStatus, EnemyStatus, Currency, StatBreakdown, AlertText, EnemyActive, TowerTile, AreaMap, DisplayRow, TrinketItem, HeirloomBoost, MultName, Sigil },
  data: () => ({
    showTowers: false,
    showRaidboss: false,
    showMap: false,
